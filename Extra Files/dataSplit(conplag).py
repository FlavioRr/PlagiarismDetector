...
# Define paths
base_data_path = r'C:\Users\Flavio Ruvalcaba\Documents\Escuela\Universidad\8Semestre\PlagiarismDetector\data\conplag_version_2\versions'
folders = ['version_1', 'version_2', 'bplag_version_1', 'bplag_version_2']
...
def move_files(labels, data_path):
...
# Mover los archivos de todas las carpetas
for folder in folders:
    data_path = os.path.join(base_data_path, folder)
    move_files(labels, data_path)

...
def save_preprocessed_data(data, output_path):
    ...
    joblib.dump((rf_model, tfidf_vectorizer), output_path)
...
if __name__ == "__main__":
    ...
    save_preprocessed_data(processed_data, r'C:\Users\Flavio Ruvalcaba\Documents\Escuela\Universidad\8Semestre\PlagiarismDetector\Preprocessing\random_forest_model_with_features.pkl')

...
if __name__ == "__main__":
    java_files_directory = r'C:\Users\droid\Documents\Aplicaciones_Avanzadas\Proyecto\PlagiarismDetector\finalDataset\javafiles'
    labels_file_path = r'C:\Users\droid\Documents\Aplicaciones_Avanzadas\Proyecto\PlagiarismDetector\finalDataset\unify_labels\javafiles_labels.csv'
    processed_data = preprocess_data_with_ast(java_files_directory, labels_file_path)
    save_preprocessed_data(processed_data, r'C:\Users\droid\Documents\Aplicaciones_Avanzadas\Proyecto\PlagiarismDetector\Preprocessing\preprocessed_all_data.pkl')
